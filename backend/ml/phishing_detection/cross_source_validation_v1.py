...
OUTPUT_PATH = Path(
    r"C:\Users\dubey\DeepShield-AI\backend\ml\phishing_detection\cross_source_validation_v1.csv"
)

RANDOM_STATE = 42


# Sources containing both legitimate and threat examples
MIXED_SOURCES = [
    "CEAS_08",
    "Enron",
    "Ling",
...
print("=" * 95)
print("DEEPSHIELD AI - CROSS-SOURCE GENERALIZATION TEST V1")
print("=" * 95)
...
print(
    "Each evaluation source was completely excluded "
    "from model training."
)

print(
    "This provides a stricter generalization test "
    "than the normal random validation split."
)

print(
    "The final held-out phishing_test_v1.csv has "
    "still NOT been used for final evaluation."
)


print("\n" + "=" * 95)
print("CROSS-SOURCE TEST COMPLETE")
print("=" * 95)